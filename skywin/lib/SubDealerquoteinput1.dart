...
import 'farmer.dart';
// import 'framertable/table.dart';
// import 'SubDealerquoteinput.dart';
// import 'adminhome.dart';

void main(List<String> args) {
  runApp(
      MaterialApp(debugShowCheckedModeBanner: false, home: SubDealerquote1()));
}
var seletedDate;

var baseurl = 'http://194.163.43.178:8000';
void loginapi(Weighttype, Grossweight, GunnyBagsweight, Rate, totalamont, Date,
    Netweight) async {
  print('ddddd' + Date.toString());
  var url = Uri.parse('$baseurl/sub_dealer_input/');
...
class SubDealerquote1 extends StatefulWidget {
  const SubDealerquote1({Key? key}) : super(key: key);

  @override
  State<SubDealerquote1> createState() => _SubDealerquote1State();
}

class _SubDealerquote1State extends State<SubDealerquote1> {
  @override
                                        ...
                                        weightValue.toString() !=
                                            ...
                                            : Container(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  controller: GunnyBagsweightController,
                                                                                        ...
                                                                                        onPressed: () {
                                                                                          if (weightValue.toString() == 'null') {
                                                                                            Fluttertoast.showToast(
                                                                                                msg: 'Enter categeri');
                                                                                          } else if (GrossweightController
                                                                                              .text.isEmpty) {
                                                                                            Fluttertoast.showToast(
                                                                                                msg: 'Enter Value');
                                                                                          } else if (GunnyBagsweightController
                                                                                              .text.isEmpty) {
                                                                                            Fluttertoast.showToast(
                                                                                                msg: 'Enter Value');
                                                                                            ...
                                                                                            Fluttertoast.showToast(
                                                                                                msg: 'Enter Value');
                                                                                          } else if (totalamontController
                                                                                              .text.isEmpty) {
                                                                                            Fluttertoast.showToast(
                                                                                                msg: 'Enter Value');
                                                                                          } else if (NetweightController
                                                                                              .text.isEmpty) {
                                                                                            Fluttertoast.showToast(
                                                                                                msg: 'Enter Value');
