...
class SubDealerquote2 extends StatefulWidget {
  ...
  @override
  State<SubDealerquote2> createState() => _SubDealerquote2State();
}

class _SubDealerquote2State extends State<SubDealerquote2> {
...
// bool iscolse=true;
                                                                          ...
                                                                          weightValue.toString() != 'Manual Weight'
                                                                              ...
                                                                              : Container(
                                                                                  ...
                                                                                  child: TextFormField(
                                                                                    onChanged: (o) {
                                                                                      setState(() {
                                                                                        totalamontController.text = (int.parse(NetweightController.text.isEmpty ? '0' : NetweightController.text) * int.parse(RateController.text.isEmpty ? '0' : RateController.text)).toStringAsFixed(0);
                                                                                      });
                                                                                    },
  ...
  void loginapi(
    ...
    var url = Uri.parse('$baseurl/Quotation/${id}');
    final response = await http.put(url, headers: {}, body: <String, String>{
      'date': date,
  ...
  Future<void> Quotation() async {
    var id = widget.iddata;
    var url = "http://194.163.43.178:8000/Quotation/$id/";
    ...
    setState(() {
      Quotationdata = decodeValue["data"];
      setState(() {
        // DateController.text = Quotationdata["date"];
        weightValue = Quotationdata["weight_type"];
        NetweightController.text = Quotationdata["net_weight"].toString();
        RateController.text = Quotationdata["rate"].toString();
        totalamontController.text = Quotationdata["total_amount"].toString();
  ...
  Future<void> editQuotation(
    ...
    var finalurl = Uri.parse(url);
    var res = await http.put(finalurl, headers: {
