...
class _viewrepotState extends State<viewrepot> {
  ...
  datefilter(formdate, todate) async {
    var url = "http://194.163.43.178:8000/date_filter/";
    ...
    var decodeValue = json.decode(res.body);
    setState(() {
      baldata = decodeValue["bal"] ?? [];
      datefilternetbaldata = decodeValue;
    });
  }
                    ...
                    children: [
                      ...
                      IconButton(
                          ...
                          onPressed: () {
                            ...
                            endDateController
                                .clear(); // print(passwordController.text);
                          }),
                      SizedBox(
                        width: 10,
                      ),
